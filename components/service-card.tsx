...
export function ServiceCard({
  ...
  return (
    <article className="premium-card flex h-full flex-col rounded-lg p-6 pl-8 transition hover:-translate-y-1 hover:shadow-raised">
      ...
      <Link
        href={href}
        className="mt-8 inline-flex min-h-11 items-center justify-center gap-2 rounded-md border border-primary/20 bg-white px-4 py-3 text-sm font-bold text-ink shadow-sm transition hover:-translate-y-0.5 hover:border-secondary hover:bg-cream"
      >
